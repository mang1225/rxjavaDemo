...
public class RxBusDemo_Bottom3Fragment extends RxFragment {
    ...
    public void onStart() {
        ...
        tapEventEmitter.compose(this.bindToLifecycle()).subscribe(new Action1<Object>() { //一个一旦被触发就会显示TapText的监听者
            @Override
        ...
        tapEventEmitter.compose(this.bindUntilEvent(FragmentEvent.DESTROY)).publish(new Func1<Observable<Object>, Observable<List<Object>>>() {//一个出发后缓存一秒内的点击数并显示的监听者
            @Override
